...
public class SpecialActivity extends AppCompatActivity {
    ...
    private ListView.OnItemClickListener jsonlvobjListener = new ListView.OnItemClickListener(){
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id){
            ...
            intent.setClass(SpecialActivity.this,ListviewActivity.class);
    ...
    protected void Func()
    {
        jsonlvobj = (ListView) findViewById(R.id.lst);
        String urlParkingArea = "http://120.110.113.104:8080/recommend/"+userid;
